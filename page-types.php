	...
	<main id="main">
		...
		<section id="types" class="section c-section">
				<div class="sec-inner c-inner">
						<div class="sec-box">
						<a href="<?php echo home_url("licence/#tab-standard"); ?>" class="box-item js-inview fadeup">
						...
						<a href="<?php echo home_url("licence/#tab-motorcycle"); ?>" class="box-item js-inview fadeup">
						...
						<a href="<?php echo home_url("licence/#tab-semi-mid"); ?>" class="box-item js-inview fadeup">
						...
						<a href="<?php echo home_url("licence/#tab-second"); ?>" class="box-item js-inview fadeup">
								<div class="image image-green"><img src="" alt="" class="u-img-contain"></div>
								<p class="btm-btn"><span class="txt">二種</span><span class="arrow"></span></p>
						</a>
						<a href="<?php echo get_page_url("class"); ?>" class="box-item js-inview fadeup">
